...
import { AiOutlineFolder, AiOutlineFolderAdd, AiOutlineGift } from "react-icons/ai";
    ...
    <div className="w-full h-[89vh] bg-white shadow-sm overflow-y-scroll sticky top-0 left-0 z-10 ">
      ...
      <div className="w-full flex items-center p-4">
        <Link to={"/dashboard"} className="w-full flex items-center">
          ...
          />
          <h5
            className={`800px:block pl-2 hidden text-[18px] font-[400] ${
      ...
      {/* All Ordes Items */}
      <div className="w-full flex items-center p-4">
        <Link to={"/dasboard-orders"} className="w-full flex items-center">
          <FiShoppingBag
            size={30}
